...
#ifndef VALIFYAPP_SWIFT_H
#define VALIFYAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ValifyApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9ValifyApp11AppDelegate")
...
SWIFT_CLASS("_TtC9ValifyApp18MainViewController")
@interface MainViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified capturedSelfiImageView;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified takeSelfiButton;
...
SWIFT_CLASS("_TtC9ValifyApp13SceneDelegate")
...
SWIFT_CLASS("_TtC9ValifyApp8SplashVC")
