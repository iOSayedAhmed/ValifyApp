...
extension ImageResource {
    ...
    static let valifyLogo = ImageResource(name: "Valify-logo", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "Valify-logo" asset catalog image.
    static var valifyLogo: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .valifyLogo)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "Valify-logo" asset catalog image.
    static var valifyLogo: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .valifyLogo)
#else
        .init()
